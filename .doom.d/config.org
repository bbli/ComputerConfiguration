...
* Adding Automatic Clock to Org Mode Headers :Org:
...
#+RESULTS:
* EXWM My own focus mode with write_ahead log on the side
...
#+RESULTS:
* Asking user to move notes to Obsidian when Done
#+begin_src emacs-lisp
...
#+RESULTS:
| benson/ask-user-to-move-to-obsidian |
