...
vim.api.nvim_set_keymap('n', '<leader>wO', "<C-w>T",
  { noremap = true, silent = true, desc = "Tear off Buffer to new Workspace" })
vim.api.nvim_set_keymap('n', '<leader>wo', ":tab split<CR>",
  { noremap = true, silent = true, desc = "Open Buffer in new Workspace" })
vim.api.nvim_set_keymap('n', '<leader>wp', ":tabprevious<CR>",
  { noremap = true, silent = true, desc = "Previous workspace" })
vim.api.nvim_set_keymap('n', '<leader>wn', ":tabnext<CR>",
